...
export const insightsAnalystChatStreamChunkSchema = z.discriminatedUnion('type', [
	z
		.object({
	...
	z
		.object({
			...
			response: insightsAnalystChatResponseSchema,
		})
		.strict(),
]);
export type InsightsAnalystChatStreamChunk = z.infer<typeof insightsAnalystChatStreamChunkSchema>;
