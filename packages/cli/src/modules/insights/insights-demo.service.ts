import type { InsightsAnalystOverview, InsightsByWorkflow } from '@n8n/api-types';

type InsightsAnalystHighlight = InsightsAnalystOverview['highlights'][number];
type InsightsAnalystLowImpactWorkflow = InsightsAnalystOverview['lowImpactWorkflows'][number];
import {
