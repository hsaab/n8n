...
const InsightsChartFailureRate = defineAsyncComponent(
	async () => await import('@/features/execution/insights/components/charts/InsightsChartFailureRate.vue'),
);
...
.chartCard {
	height: calc(var(--spacing--5xl) + var(--spacing--5xl) + var(--spacing--5xl) + var(--spacing--xl));
	padding: var(--spacing--lg);
}
